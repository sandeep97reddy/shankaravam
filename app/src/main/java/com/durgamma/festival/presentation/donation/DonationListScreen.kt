...
fun DonationListScreen(
    ...
    val eventVm: com.durgamma.festival.presentation.event.EventViewModel =
        containerViewModel { c -> com.durgamma.festival.presentation.event.EventViewModel(c, c.sessionPrefs) }
        ...
        topBar = {
            androidx.compose.material3.CenterAlignedTopAppBar(
                ...
                colors = androidx.compose.material3.TopAppBarDefaults.centerAlignedTopAppBarColors(
                    containerColor = com.durgamma.festival.core.theme.DeepMaroon,
                    titleContentColor = com.durgamma.festival.core.theme.TempleGold,
                    navigationIconContentColor = com.durgamma.festival.core.theme.TempleGold
                )
            )
        }
    ) { padding ->
